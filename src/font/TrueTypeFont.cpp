...
TrueTypeFont::TrueTypeFont(std::string fontPath) {
  FT_Library ft;
  ...
  for (unsigned char c = 0; c < nbCharList; c++) {
...
void TrueTypeFont::RenderText(Shader& shader, std::string text, float x, float y, float scale,
                              glm::vec3 color) {
